...
$xml .= "<ShortName>Documentor " ._kt('Quick Search') . "</ShortName>\r\n";
$xml .= "<Description>" . _kt('Search metadata and content on Documentor') . "</Description>\r\n";
$xml .= "<Image width=\"16\" height=\"16\" type=\"image/x-icon\">$url/favicon.ico</Image>\r\n";
